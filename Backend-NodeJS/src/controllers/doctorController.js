...
let getListPatientHistoryForDoctor = async (req, res) => {
    try {

        let infor = await doctorService.getListPatientHistoryForDoctor(req.query.doctorId, req.query.date);
        return res.status(200).json(infor);
    } catch (e) {
...
let getSpecialty = async (req, res) => {
    try {
        ...
        let infor = await doctorService.getSpecialty(req.body);
        return res.status(200).json(infor);
    } catch (e) {
        console.log(e)
        return res.status(200).json({
